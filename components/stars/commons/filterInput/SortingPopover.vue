    ...
    <Popover>
        <PopoverTrigger as-child>
            <Button variant="ghost">
                ...
                <ArrowDownAZ v-else-if="sort.order === SORT_ORDER.DESC" class="w-4 h-4" />
            ...
            <div class="grid gap-4">
                ...
                <div class="grid gap-2">
                    <template v-for="(sortItem, index) in sorts" :key="index">
                        <Button variant="ghost" class="flex items-center justify-between" @click="sortIt(sortItem)">
...
export default {
    ...
    components: {
        Popover, PopoverContent, PopoverTrigger, ArrowUpAZ, ArrowDownAZ, SlidersHorizontal,
    }, props: {
        sorts: {
